...
module.exports = {
    ...
    SONG_DOWNLOAD: process.env.SONG_DOWNLOAD === undefined ? '✅DOWNLOADING SONG࿐😍' : process.env.SONG_DOWNLOAD,
    SONG_UPLOAD: process.env.SONG_UPLOAD === undefined ? '😏UPLOADING SONG࿐😍' : process.env.SONG_UPLOAD,
