/* Codded by Black Mamba🐍
Telegram: t.me/Black Mamba🐍
Instagram: Black Mamba🐍
*/
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'ss ?(.*)', fromMe: true, desc: Lang.SS_DESC}, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'Made by Black Mamba🐍'})
...
Asena.addCommand({pattern: 'sparkling ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
  ...
  var topText, bottomText;
    ...
    await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '*made By  RAVANA*' })
...
Asena.addCommand({pattern: 'watercolor ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '*Made By  Black Mamba🐍*' })
...
Asena.addCommand({pattern: 'sandwriting ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/sandwriting?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
 ...
 Asena.addCommand({pattern: 'cloud ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/cloudtext?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
  ...
  var topText, bottomText;
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/ph?text=${topText}&text2=${bottomText}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
...
Asena.addCommand({pattern: 'snow ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/snowtext?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
  ...
  Asena.addCommand({pattern: 'blood ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/bloodontheroastedglass?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '*Made By  Black Mamba🐍*'})
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/3dluxury?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/3dgradient?text=${match[1]}&APIKEY=81b89daeb4288b19vv`, { responseType: 'arraybuffer' })
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/realisticvintage?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/summerysandwriting?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/metaldarkgold?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/1917?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/holographic3d?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/deluxesilver?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/glossybluemetal?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/fabric?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
  ...
  var topText, bottomText;
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/3davengers?text=${topText}&text2=${bottomText}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
  ...
  var topText, bottomText;
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/marvel?text=${topText}&text2=${bottomText}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
  ...
  var topText, bottomText;
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/3dmetalsilver?text=${topText}&text2=${bottomText}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '*Made By  Black Mamba🐍*'})
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/3dglue?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/balloontext?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
  ...
  var topText, bottomText;
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/3drosegold?text=${topText}&text2=${bottomText}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
  ...
  var topText, bottomText;
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/3dmetalgold?text=${topText}&text2=${bottomText}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
  ...
  var topText, bottomText;
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/lionlogomascot?text=${topText}&text2=${bottomText}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '*Made By  Black Mamba🐍*'})
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/jokerlogo?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/naturalleaves?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/skeleton?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/robotr2d2?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/toxic?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/rainbowequalizer?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/orangeglass?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
  ...
  var topText, bottomText;
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/marvelstudios?text=${topText}&text2=${bottomText}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
...
Asena.addCommand({pattern: 'snow ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
  ...
  Asena.addCommand({pattern: 'blood ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '*Made By  Black Mamba🐍*'})
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/3dluxury?text=${match[1]}&AAPIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '*Made By  Black Mamba🐍*'})
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/3dgradient?text=${match[1]}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
  ...
  var topText, bottomText;
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/3dmetalgalaxy?text=${topText}&text2=${bottomText}&APIKEY=81b89daeb4288b19`, { responseType: 'arraybuffer' })
